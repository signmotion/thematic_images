...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/thematic_images.git`).
...
Go to the [pull request page of ThematicImageGenerator][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/thematic_images/issues/new
[GitHub issues]: https://github.com/signmotion/thematic_images/issues
[PRs]: https://github.com/signmotion/thematic_images/pulls
